...
if __name__ == "__main__":
    while True:
        ...
        if "wake up" in query or "makeup" in query or "make up" in query or "wake" in query:
            ...
            while True:
                ...
                #################### JARVIS: THe Trilogy 2.0 #####################
                    ...
                    new_password = open("password1.txt","w")
